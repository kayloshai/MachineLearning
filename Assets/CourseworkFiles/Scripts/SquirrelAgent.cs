...
{
    SquirrelAcademy m_MyAcademy;
    public GameObject area;
    SquirrelArea m_MyArea;
    bool m_Frozen;
    bool m_Poisoned;
    bool m_Satiated;
    bool m_Shoot;
    ...
    public override void InitializeAgent()
    {
        ...
        m_MyArea = area.GetComponent<SquirrelArea>();
        m_MyAcademy = FindObjectOfType<SquirrelAcademy>();
    ...
    public void MoveAgent(float[] act)
    {
        ...
        if (m_Shoot)
        {
            ...
            if (Physics.SphereCast(transform.position, 2f, rayDir, out hit, 25f))
            {
                ...
                {
                    hit.collider.gameObject.GetComponent<SquirrelAgent>().Freeze();
                }
            }
        }
        else
    ...
    void OnCollisionEnter(Collision collision)
    {
        ...
        {
            Satiate();
            collision.gameObject.GetComponent<SquirrelFoodLogic>().OnEaten();
            AddReward(1f);
            if (contribute)
            {
